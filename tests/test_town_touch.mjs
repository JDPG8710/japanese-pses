...
try{
 ...
 await page.locator('#help').tap();assert.match(await page.locator('#dialog-body').innerText(),/答案只作提示/);assert.doesNotMatch(await page.locator('#dialog-body').innerText(),/自动带路/);await page.locator('.close-button').tap();
