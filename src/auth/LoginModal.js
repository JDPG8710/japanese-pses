    ...
    this.element.innerHTML = `
      <section role="dialog" aria-modal="true" aria-labelledby="auth-title" class="w-full max-w-md rounded-3xl border border-indigo-300/30 bg-slate-900 p-6 text-white shadow-2xl sm:p-8">
        ...
        <div class="mt-5 grid gap-3">
          ...
          <button type="button" data-action="guest" disabled class="min-h-14 rounded-2xl border border-amber-300/50 bg-amber-400/15 px-4 font-black text-amber-200 transition hover:bg-amber-400/25 disabled:cursor-not-allowed disabled:opacity-40">10分間ゲスト体験</button>
        </div>
