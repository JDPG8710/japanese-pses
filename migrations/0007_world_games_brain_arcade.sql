-- Expand the server-authoritative game allow-list while preserving existing scores.
CREATE TABLE world_runs_brain_arcade (
...
INSERT INTO world_runs_brain_arcade SELECT * FROM world_runs;
DROP TABLE world_runs;
ALTER TABLE world_runs_brain_arcade RENAME TO world_runs;
